<?php
    ...
    if(isset($_POST['estudiantes'])&& isset($_POST['Id_est']) && isset($_POST['curso'])&&isset($_POST['paralelo'])&&isset($_POST['materia'])){
        ...
        $sql="INSERT INTO curso_est (Id_est,nivel_curso,paralelo,materia) VALUES(?,?,?,?)";

        $stmt = $conexion->prepare($sql);
        
        if($stmt){
            $stmt->bind_param("isss",$idEs,$curso,$paralelo,$materia);
            if ($stmt->execute()) {
